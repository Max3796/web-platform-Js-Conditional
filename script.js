...
submitButton1.onclick = () => {
  let score = document.getElementById('number-input1').value;
...
submitButton2.onclick = () => {
  let score1 = document.getElementById('number-input2').value;
